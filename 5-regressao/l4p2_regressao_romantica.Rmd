...
Os resultados da regressão indicam que um modelo com os 5 preditores no formato $produtividade = -0,66 + 0,78*prob + 0.006*int_corr + 0.005*like + 0.006*intel + 0.005*attr$ explicam 51,55% da variância da variável de resposta (R2 = 0.5155). 
