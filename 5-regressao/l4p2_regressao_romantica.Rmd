...
dados %>%
  ...
  scale_x_continuous(breaks=seq(0, 10, by = 1)) +
  scale_y_continuous(breaks=seq(0, 10000, by = 100)) +
  labs(x= "Probabilidade de um novo encontro (int_corr)",
       y = "Quantidade")
``` 
